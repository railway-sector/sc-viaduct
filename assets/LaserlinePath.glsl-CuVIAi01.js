import{IB as be,Ix as we,IT as Ve,GB as f,HN as w,IG as De,GC as W,Gy as r,cX as z,xy as ee,IA as xe,Hr as E,dH as te,dF as A,fi as B,IU as ye,i$ as ie,HL as ne,H3 as S,eq as m,dE as v,IV as se,zF as ae,bM as o,m7 as re,iz as Le,r$ as Ee,dI as Se,dP as le,gJ as oe,ix as Ce,Iy as Me,xM as Ae,H1 as $e,HV as Re,Gx as F,hr as Te,qC as ce,qE as he,_ as de,hs as Ie,ep as G,q9 as q,a9 as c,ac as j,jH as pe,ht as ue,by as Oe,dG as O,lJ as Ue,He as qe,lL as ze,IW as je,GN as D,nS as Ne,nT as X,IX as He,mI as We,IY as $,IZ as Be,wB as k,rX as Fe,vg as Ge,rY as Xe,rZ as ke,r_ as Ze,s0 as Je,ab as C,I_ as Ye,nA as Z}from"./index-Dqa76_Lo.js";import{t as Qe}from"./VisualElement-DoKu4TWR.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(Ve),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
