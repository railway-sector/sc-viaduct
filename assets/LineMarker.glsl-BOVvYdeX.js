import{xy as te,HT as ie,HU as re,Gu as ae,HV as se,HW as oe,Gy as o,HM as ne,H1 as ce,HL as le,Gx as y,HX as pe,HY as de,H5 as I,Gw as he,Gz as ve,GA as ue,Hr as me,GC as fe,HZ as N,H_ as E,H$ as Se,I0 as ge,H6 as Pe,ht as ye,qC as _e,jH as we,qE as xe,_ as ze,qG as D,GE as R,GF as $e,GG as U,qH as L,GI as be,GJ as Ve,GL as ke,I1 as Oe,I2 as q,I3 as B,I4 as Te,I5 as Ce,I6 as We,a9 as d,ac as De,H8 as Me,GN as m,h8 as Le,GP as M,Hb as je,I7 as Y,ty as He,HD as Ae,I8 as Fe,GQ as Ge,dG as Q,kt as Ie,eq as J,bM as X,I9 as Ne}from"./index-Bd_wUdYi.js";function Z(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,V=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:g,varyings:S}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),S.add("vColor","vec4"),S.add("vpos","vec3",{invariant:!0}),S.add("vUV","vec2"),S.add("vSize","float"),_&&S.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),_&&(e.include(E),g.constants.add("relativeMarkerSize","float",Se/N).constants.add("relativeTipLineWidth","float",ge).code.add(o`
