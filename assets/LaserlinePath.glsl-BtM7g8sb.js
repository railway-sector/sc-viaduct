import{Jy as Pe,Ju as be,JZ as we,Hs as f,IJ as w,JA as Ve,Ht as W,Hp as r,fp as U,x3 as Y,Jx as De,Im as C,f6 as ee,hI as R,g3 as F,J_ as xe,hr as te,IH as ie,H$ as M,f7 as m,f8 as v,J$ as ne,zn as se,cw as o,mu as ae,j7 as Ee,jq as ye,hJ as Le,eo as re,hx as le,j5 as Se,Jv as Ce,xh as Me,HZ as Ae,IR as $e,Ho as B,ii as Re,Hv as oe,Hw as ce,_ as he,po as Te,f5 as J,jr as O,az as c,aE as z,jZ as de,jX as pe,et as Ie,en as I,lX as je,I8 as Oe,m0 as qe,K0 as Ue,HK as D,JE as ze,JF as G,K1 as He,n2 as Ne,K2 as T,K3 as We,jl as Fe,v8 as Be,jn as Je,jo as Ge,jp as Ke,js as Xe,aA as A,K4 as Ze,pX as K}from"./index-Dm1741zB.js";import{t as ke}from"./VisualElement-DYeIC9HI.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
