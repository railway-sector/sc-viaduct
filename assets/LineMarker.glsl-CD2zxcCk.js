import{wm as X,Hq as Z,Hr as ee,G1 as te,F$ as ie,Hs as re,Ht as ae,G6 as o,Hj as se,GF as oe,Hi as ne,G5 as w,Hu as ce,Hv as le,G2 as pe,G4 as de,G7 as he,H2 as ve,G9 as ue,Hw as A,Hx as F,Hy as me,Hz as fe,GJ as ge,hr as Se,Ga as Pe,Gb as ye,_ as _e,Gc as M,Gd as N,Ge as we,Gf as E,Gg as L,GL as ze,Gi as xe,Gj as $e,Gk as be,Gm as V,Gn as Te,HA as Ve,HB as R,HC as U,HD as ke,HE as Oe,HF as De,Go as Ce,n as p,Gp as d,ho as We,GM as Me,HG as I,rj as Le,Ha as je,ll as Ge,Gu as He,dp as B,ye as Ae,eH as q,dA as J,HH as Fe}from"./index-BQbkghma.js";function Y(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
