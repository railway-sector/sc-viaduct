import{IC as be,Iy as we,IU as De,GC as f,HO as w,IH as Ve,GD as W,Gz as r,cX as q,xz as ee,IB as xe,Hs as E,dH as te,dF as A,fi as B,IV as ye,i$ as ie,HM as ne,H4 as S,eq as m,dE as v,IW as se,zG as ae,bM as o,m7 as re,iz as Le,r$ as Ee,dI as Se,dP as le,gJ as oe,ix as Ce,Iz as Me,xN as Ae,H2 as $e,HW as Re,Gy as F,hr as Te,qC as ce,qE as he,_ as de,hs as Ie,ep as G,q9 as z,a9 as c,ac as j,jH as pe,ht as ue,by as Oe,dG as O,lJ as Ue,Hf as ze,lL as qe,IX as je,GO as V,nS as Ne,nT as X,IY as He,mI as We,IZ as $,I_ as Be,wC as k,rX as Fe,vl as Ge,rY as Xe,rZ as ke,r_ as Ze,s0 as Je,ab as C,I$ as Ye,nA as Z}from"./index-apbgE4nG.js";import{t as Qe}from"./VisualElement-BUKj2S3Q.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
