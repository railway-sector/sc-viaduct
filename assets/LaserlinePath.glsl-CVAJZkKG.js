import{Ks as be,Ko as we,KK as De,Is as f,JE as w,Kx as Ve,It as B,Ip as r,d3 as z,xZ as ee,Kr as xe,Ji as E,dP as te,dN as A,fr as F,KL as Le,j9 as ie,JC as ne,IW as S,ey as _,dM as v,KM as se,Aj as ae,a4 as o,my as re,iJ as ye,sp as Ee,dQ as Se,dX as le,gT as oe,iH as Ce,Kp as Me,yb as Ae,IU as $e,JM as Re,Io as H,hB as Te,r0 as ce,r2 as he,_ as de,hC as Ie,ex as K,qz as j,af as c,ai as q,jR as pe,hD as ue,bE as Oe,dO as O,m8 as Ue,J5 as je,ma as ze,KN as qe,IE as V,oh as Ne,oi as G,KO as We,n7 as Be,KP as $,KQ as Fe,x0 as J,sl as He,vL as Ke,sm as Ge,sn as Je,so as ke,sq as Qe,ah as C,KR as Xe,n$ as k}from"./index-8cOoVUGx.js";import{t as Ze}from"./VisualElement-h1OSV5jr.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
