import{J0 as be,IY as we,Ji as De,H0 as f,Ic as w,J5 as Ve,H1 as W,GZ as r,cZ as q,xE as ee,I$ as xe,HS as E,dJ as te,dH as A,fl as B,Jj as Le,j3 as ie,Ia as ne,Hu as S,es as _,dG as v,Jk as se,Ad as ae,Z as o,md as re,iD as ye,s4 as Ee,dK as Se,dR as le,gN as oe,iB as Ce,IZ as Me,xS as Ae,Hs as $e,Ik as Re,GY as F,hv as Te,qH as ce,qJ as he,_ as de,hw as Ie,er as G,qe as j,a9 as c,ac as z,jL as pe,hx as ue,by as Oe,dI as O,lP as Ue,HF as je,lR as qe,Jl as ze,Hc as V,nY as Ne,nZ as J,Jm as He,mO as We,Jn as $,Jo as Be,wH as Z,s0 as Fe,vq as Ge,s1 as Je,s2 as Ze,s3 as ke,s5 as Ye,ab as C,Jp as Xe,nG as k}from"./index-BoAsZDBl.js";import{t as Ke}from"./VisualElement-CMjuM8ED.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
