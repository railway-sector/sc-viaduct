...
}`)}let Ti=class extends Ce{constructor(){super(...arguments),this.tileCameraPosition=O(),this.cameraDelta=O()}};function Ci(i){i.code.add(_`vec4 unpackColor(uvec4 packedGaussian) {
vec4 color;
